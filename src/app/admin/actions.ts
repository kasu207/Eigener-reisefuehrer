...
export async function mergePlaces(fd: FormData) {
  ...
  // Sonst wanderte der private Tipp einer Kundin in den allgemeinen Bestand
  // (oder umgekehrt ein geprüfter Ort in einen einzelnen Guide).
  if (others.some((o) => o.addedByRequestId !== keep.addedByRequestId)) return;
