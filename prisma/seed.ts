...
async function main() {
  ...
  const places: SeedPlace[] = [
    ...
    { type: "restaurant", name: "Seeblick-Osteria (Beispiel)", locality: "Como", lat: 45.8100, lng: 9.0830, tags: ["kulinarik", "gehoben"], priceLevel: 3, dietaryOptions: ["vegetarian", "glutenfree"], access: "public", qualityScore: 3, editorNotes: "Platzhalter – gehobene Küche. Vor Launch verifizieren." },
    ...
    { type: "restaurant", name: "Ristorante am Hafen (Beispiel)", locality: "Bellagio", lat: 45.9860, lng: 9.2625, tags: ["kulinarik", "regional", "seefisch"], priceLevel: 3, dietaryOptions: ["vegetarian"], access: "public", qualityScore: 3, editorNotes: "Platzhalter – Seefisch (Lavarello, Missoltini). Vor Launch verifizieren." },
  ...
  const infos: Array<{ title: string; content: string; format: "prose" | "table" | "timeline"; sortOrder: number }> = [
    ...
    },
    {
      ...
      content: [
        ...
        "Un tavolo per due | Ein Tisch für zwei",
